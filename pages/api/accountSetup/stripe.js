...
export default authenticated(async (req, res) => {
    if (req.method === 'POST') {
        ...
        try {
            ...
            let priceId = company_id === "6668c78b5d0dfeb36eb9b008" || company_id === "66ec648cff4710f7aca19d1b" || company_id === "66fc999740dd9fbacc21060e" ? "price_1QGAmyAtBT5rPxqpqxLOoTDF" : "prod_SYjZ2p83Q7hh2I"
            ...
            const session = await stripe.checkout.sessions.create({
                ...
                line_items: [
                    {
                        price: priceId || "prod_SYjZ2p83Q7hh2I", // ID do preço que você já criou

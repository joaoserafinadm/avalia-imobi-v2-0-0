    ...
    const createCardToken = async () => {
        ...
        try {
            const cardToken = await mp.fields.createCardToken({
                ...
                identificationNumber: cpf ? maskCpf(cpf).replace(/\D/g, '') : maskCnpj(cnpj).replace(/\D/g, '')
            });

            if (cardToken && cardToken.id) {
                handlePayment(cardToken.id);
            } else {
                setSubscriptionError('Erro ao gerar cardToken');
            }
        } catch (error) {
            setSubscriptionError('Erro ao gerar o token.');
        }
    };
    ...
    const handlePayment = async (cardTokenId) => {
        ...
        await axios.post(`/api/accountSetup/subscription`, data)
            .then(res => {
                ...
                setSubscriptionError('Erro ao gerar a assinatura.');
            });
    };
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 my-2">
                                    <label className="small fw-bold" htmlFor="cardNumber">Número do cartão</label>
                                ...
                                <div className="col-6">
                                    <label className="small fw-bold" htmlFor="securityCode">Código de segurança</label>

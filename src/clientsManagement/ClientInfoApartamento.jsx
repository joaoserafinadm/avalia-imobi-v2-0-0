...
function Chip({ label, value }) {
    return (
        <div style={{
            ...
            <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: '0.95rem', fontWeight: 500, color: 'var(--theme-text-primary)', lineHeight: 1 }}>
                {value}
            </span>
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '0.85rem', color: 'var(--theme-text-primary)', lineHeight: 1 }}>
                {label}
            </span>
        </div>
    )
